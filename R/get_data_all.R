...
get_data_all_ <- function(time = today_at_sunrise()) {
  ...
  outcome_info <- tibble::tribble(
   ...
   "avg",  "new",  "tests", "cap", "tiny",          p("This time series chart shows the", strong("average number"), "of", strong("tests per 1000 of population for the selected time range"), ". Due to data inconsistencies, we show a moving 7-day average."),
   ...
   "avg",  "new",  "cases", "cap", "tiny",          p("This time series chart shows the", strong("average number"), "of", strong("cases per 1000 of population for the selected time range"), ". Due to data inconsistencies, we show a moving 7-day average."),
   ...
   "avg",  "new",  "deaths", "cap", "tiny",         p("This time series chart shows the", strong("average number"), "of", strong("deaths per 1000 of population for the selected time range"), ". Due to data inconsistencies, we show a moving 7-day average."),
